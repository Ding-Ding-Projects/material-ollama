...
The current landing-page source exposes a registry record for all 85 canonical IDs. The Windows release evidence is now verified for `v0.0.0-build.9`; real built-artifact captures remain recorded separately as pending until that evidence lane completes.
